...
$("#address_detail").html('<figure><i class="fa fa-map-marker"></i>'+detail['address']+'</figure><figure><i class="fa fa-phone"></i>'+detail['phone']+'</figure><figure><i class="fa fa-envelope"></i>'+detail['email']+'</figure><figure><i class="fa fa-globe"></i>'+detail['website']+'</figure>');
